...
namespace LocadoraDeAutomoveis.Infra.Migrations
{
    ...
    [Migration("20240824155317_TBPlanoCobranca")]
    partial class TBPlanoCobranca
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocadoraDeAutomoveis.Dominio.ModuloPlanoCobranca.PlanoCobranca", b =>
                {
                    ...
                    b.Property<decimal?>("PrecoDiariaDiario")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("PrecoDiariaDiario");

                    b.Property<decimal?>("PrecoDiariaLivre")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("PrecoDiariaLivre");

                    b.Property<decimal?>("PrecoDiarioControlado")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                    ...
                    b.Property<decimal?>("PrecoProKmExcedido")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                    ...
                    b.HasDiscriminator<int>("TipoPlanoCobranca");
            ...
            modelBuilder.Entity("LocadoraDeAutomoveis.Dominio.ModuloPlanoCobranca.PlanoControlado", b =>
                {
                    b.HasBaseType("LocadoraDeAutomoveis.Dominio.ModuloPlanoCobranca.PlanoCobranca");
            ...
            modelBuilder.Entity("LocadoraDeAutomoveis.Dominio.ModuloPlanoCobranca.PlanoDiario", b =>
                {
                    b.HasBaseType("LocadoraDeAutomoveis.Dominio.ModuloPlanoCobranca.PlanoCobranca");
                    ...
                    b.ToTable("TBPlanoCobranca", t =>
                        {
                            t.Property("PrecoDiaria")
                                .HasColumnName("PlanoDiario_PrecoDiaria");
                        });

                    b.HasDiscriminator().HasValue(0);
                });

            modelBuilder.Entity("LocadoraDeAutomoveis.Dominio.ModuloPlanoCobranca.PlanoLivre", b =>
                {
                    b.HasBaseType("LocadoraDeAutomoveis.Dominio.ModuloPlanoCobranca.PlanoCobranca");
                    ...
                    b.ToTable("TBPlanoCobranca", t =>
                        {
                            t.Property("PrecoDiaria")
                                .HasColumnName("PlanoLivre_PrecoDiaria");
                        });
